...
## Mission
Build, validate, break, repair and clean up a small Azure capability for **Toolchain**. This workshop is executable: you will create/edit files, run commands, inspect evidence, diagnose a failure and complete a challenge.
...
cd data2ai-terraform-azure-foundry/00-onboarding/lab-00-01-toolchain
```
...
AZURE_RESOURCE_GROUP=rg-data2ai-00-01-lab
```
...
az group show --name rg-data2ai-00-01-lab --query "{name:name,location:location,tags:tags}" --output json
```
