# Lab 00-02 — Azure Auth

> 🟢 **Build Lab** · Beginner → Intermediate · 45–75 min

## Mission
Build, validate, break, repair and clean up a small Azure capability for **Azure Auth**. This workshop is executable: you will create/edit files, run commands, inspect evidence, diagnose a failure and complete a challenge.
...
cd data2ai-terraform-azure-foundry/00-onboarding/lab-00-02-azure-auth
```
...
AZURE_RESOURCE_GROUP=rg-data2ai-00-02-lab
```
...
az group show --name rg-data2ai-00-02-lab --query "{name:name,location:location,tags:tags}" --output json
```
