# Lab 01-01 — First Resource

> 🟢 **Build Lab** · Beginner → Intermediate · 45–75 min

## Mission
Build, validate, break, repair and clean up a small Azure capability for **First Resource**. This workshop is executable: you will create/edit files, run commands, inspect evidence, diagnose a failure and complete a challenge.
...
cd data2ai-terraform-azure-foundry/01-azure-foundations/lab-01-01-first-resource
```
...
AZURE_RESOURCE_GROUP=rg-data2ai-01-01-lab
```
...
az group show --name rg-data2ai-01-01-lab --query "{name:name,location:location,tags:tags}" --output json
```
