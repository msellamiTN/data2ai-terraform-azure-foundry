...
Build the **Rbac** scenario as an engineer. You must create or edit the important files, execute the commands, read the outputs, validate the result, diagnose a controlled failure, repair it and complete the challenge.
