...
## Mission
Build **Project** as an executable Azure engineering workshop.
...
## Build
```powershell
cd data2ai-terraform-azure-foundry/03-terraform-azure/lab-03-01-project
...
az group show --name rg-data2ai-03-01-lab --output json
terraform output
